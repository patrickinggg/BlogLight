  ...
  var Gallery = new Vue({
    ...
    methods: {
      ...
      loadfollowers: function(){
            ...
            for (var obj in listObj){
              (function (_obj) {
                ...
                getimghttp.addEventListener("load", function(event){
                  ...
                  getnamehttp.open("GET", webUrl +"/user/glance/?id="+listObj[_obj].fanid);
                  getnamehttp.addEventListener("load", function(event){
                    ...
                    if (imgObj.collection.length == 0){
                      var resultObj = {
                        ...
                        link: blogUrl+"/blog/friends_blog_page/id="+ listObj[_obj].fanid +"&homeId="+id
                      }
                      result.push(resultObj);
                    } else {
                      var avatarhttp = new XMLHttpRequest();
                ...
                getimghttp.send("domain=avatar&usrId=" +listObj[_obj].fanid);
              }(obj));
            }
            self.users = result;
            console.log("result");
        ...
        xhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
        xhttp.send("mode=2&pageSize=8&pageIndex="+self.pagenumber);
